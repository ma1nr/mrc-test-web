...
# Убираем все предыдущие регистрации (на всякий случай)
try:
...
# Регистрируем заново с ПРАВИЛЬНЫМИ полями
...
class ScheduleAdmin(admin.ModelAdmin):
    # ИСПРАВЛЯЕМ: используем те поля, которые ЕСТЬ в модели
    ...
    # Опционально: добавим кастомное отображение
